  ...
  processMessage: function(_message, callback) {
    ...
    getUser(user).then(function(dbUser) {
      ...
      .then(function(messageResponse) {
        ...
        var keywords = messageResponse.entities;

        if(keywords) {
            if (!messageResponse.context.keywords) {
                messageResponse.context.keywords = keywords;
            } else {
                messageResponse.context.keywords = extend(messageResponse.context.keywords, keywords);
            }
        }
